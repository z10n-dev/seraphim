    ...
    PanelWindow {
        ...
        screen: {
            for (var i = 0; i < Quickshell.screens.length; i++) {
                ...
                if (!mon)
                    continue;
                var monWs = Hyprland.workspaces.values.filter(w => w.monitor && w.monitor.name === mon.name && w.id >= 1 && w.id <= 10);
                if (monWs.length > 0)
                    return scr;
            }
        ...
        Item {
            ...
            Row {
                ...
                Item {
                    ...
                    MouseArea {
                        anchors.fill: parent
                        onClicked: Quickshell.exec(["alacritty", "-e", "hyprctl", "reload"])
                    }
            ...
            Row {
                ...
                Item {
                    ...
                    Text {
                        id: powerModeIcon
                        anchors.verticalCenter: parent.verticalCenter
                        text: root.powerMode === "power-saver" ? "\uf06c" : root.powerMode === "performance" ? "\uf135" : "\udb80\udd39"
                        color: root.powerMenuOpen ? root.colCyan : root.powerMode === "power-saver" ? root.colGreen : root.powerMode === "performance" ? root.colRed : root.colYellow
                        font {
                            family: root.fontFamily
                            pixelSize: root.fontSize
                        }
                ...
                Item {
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        hoverEnabled: true
                        onClicked: Quickshell.execDetached(["alacritty", "-e", "wlctl"])
                    }
                    ...
                    Row {
                        ...
                        Text {
                            id: wifiIcon
                            anchors.verticalCenter: parent.verticalCenter
                            text: root.wifiSsid === "" ? "\uf05e" : root.wifiSignal >= 75 ? "\uf1eb" : root.wifiSignal >= 50 ? "\udb82\udd2d" : root.wifiSignal >= 25 ? "\udb82\udd2c" : "\udb82\udd2f"
                            color: root.wifiSsid === "" ? root.colMuted : root.wifiSignal >= 50 ? root.colGreen : root.wifiSignal >= 25 ? root.colYellow : root.colRed
                            font {
                                family: root.fontFamily
                                pixelSize: root.fontSize
                            }
                ...
                Item {
                    ...
                    Row {
                        ...
                        Text {
                            id: volIcon
                            anchors.verticalCenter: parent.verticalCenter
                            text: root.volMuted ? "\ueee8" : root.volLevel < 40 ? "\uf027" : "\uf028"
                ...
                Item {
                    ...
                    Row {
                        ...
                        Text {
                            id: batIcon
                            anchors.verticalCenter: parent.verticalCenter
                            text: root.batStatus === "Charging" ? "\uf0e7" : root.batCapacity > 80 ? "\uf240" : root.batCapacity > 60 ? "\uf241" : root.batCapacity > 40 ? "\uf242" : root.batCapacity > 20 ? "\uf243" : "\uf244"
                            color: root.batStatus === "Charging" ? root.colGreen : root.batCapacity <= 20 ? root.colRed : root.colFg
                            font {
                                family: root.fontFamily
                                pixelSize: root.fontSize
                            }
            ...
            Repeater {
                ...
                delegate: Item {
                    ...
                    Rectangle {
                        anchors.fill: parent
                        radius: 4
                        color: isActive ? Qt.rgba(Qt.color(modelData.col).r, Qt.color(modelData.col).g, Qt.color(modelData.col).b, 0.15) : pmHover.containsMouse ? Qt.rgba(Qt.color(root.colFg).r, Qt.color(root.colFg).g, Qt.color(root.colFg).b, 0.08) : "transparent"
                        Behavior on color {
                            ColorAnimation {
                                duration: 120
                            }
